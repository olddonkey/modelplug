...
| `messages` | `POST /v1/messages` | Claude Code | Thinking signatures carry our `Opaque` envelope through the client transcript. Route wiring and `count_tokens` (an estimate for routed providers) land in 6b. |
